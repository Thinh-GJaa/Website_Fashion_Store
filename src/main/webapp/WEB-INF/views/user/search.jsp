...
<div>
    <div class="text-center">
        <h2 class="mt-3 mb-3">Kết quả tìm kiếm cho: ${keyword} </h2>
    </div>
    <!-- Danh sách sản phẩm  -->

    <c:if test="${empty productList}">
        <div class="empty-list">
            <img src="/resources/img/list-empty.jpg" alt="Không có kết quả" class="empty-image ">
            <p>Rất tiếc... Chúng tôi không tìm thấy thông tin nào.<br>
                Hãy cố gắng thử lại
