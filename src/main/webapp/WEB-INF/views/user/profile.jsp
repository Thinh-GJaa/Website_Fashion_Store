...
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form:form modelAttribute="customer" id="profileForm" class="text-left">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-5 text-center">
                                <c:if test="${not empty customer.image}">
                                    <img id="profileImage" src="${customer.image.linkImage}" alt="${customer.customerName}"
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label"><i class="fas fa-user"></i> Họ và
                                        tên:</label>
                                    <div class="col-sm-8">
                                        <form:input path="customerName" cssClass="form-control-plaintext"
                                                    readonly="true"/>
                                    </div>
                                </div>
                                <div class="form-group row">
